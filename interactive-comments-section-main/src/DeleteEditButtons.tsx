...
import styles from "./DeleteEditButtons.module.css";
...
export const DeleteEditButtons: Component<DeleteEditButtonProps> = (props) => {
  ...
  const onModalClosed = (result: boolean) => {
    setShow(false);
  ...
  return (
    <>
      ...
      <Modal show={show} onClick={onModalClosed} />
    </>
  );
};
